...
public:
    ...
    onpolicy_lambda_updater(EnvType* env, const CConfigPtr& config)
        : Base(env, config)
...
{
public:
    method_state_onpolicy(env_state* env, const CConfigPtr& config);
...
{
public:
    method_action_onpolicy(env_action* env, const CConfigPtr& config);
